...
module BenchmarksSmall =
    ...
    type UnitOfWorkTest() =
        ...
        [<Benchmark(Description = "Single transaction: 2500 modified, 500 deleted")>]
        member _.scenario1() =
            let i1 = 2500
            let i2 = i1 + 500
            async {
        ...
        [<Benchmark(Description = "Nested transaction SUCCESS: Level1=2250 modified, Level2=500+250 overlapping")>]
        member _.scenario2() =
            let changed = 2000
            let overlap1 = 200
            let overlap2 = 50
